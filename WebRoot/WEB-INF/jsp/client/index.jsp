        ...
        <div class="right right1 clearfix" style="min-height: 632px;">
           ...
           <div class="xia clearfix">
           		<div class="xl">
					...
					<tr>
					<td><img src="/client/images/about_android.png" height="165" width="165" /></td>
					<td><img src="/client/images/about_ios.png" height="200" width="200" /></td>
					</tr>
					</table>
                		
                    </div>
                    <div class="saomiao">扫描下载汉典医学APP，苹果手机请自行通过设置-设备描述进行信任操作</div>
                </div>
                <div class="f_phone">
