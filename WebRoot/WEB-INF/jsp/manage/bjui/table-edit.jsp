...
//自动有效日期
$(document).on('afterchange.bjui.datepicker', '.j_custom_issuedate', function(e) {
    var pattern = 'yyyy-MM-dd'
    var start   = end = e.date
...
<div class="bjui-pageHeader">
    <form id="pagerForm" onsubmit="return navTabSearch(this);" action="table-edit.html" method="post">
        ...
        <ul class="bjui-searchBar">
            <li><label>姓名：</label><input type="text" value="" name="name" size="10" /></li>
            <li><label>护照号：</label><input type="text" value="" name="passportno" size="8" /></li>
            <li><label>出生日期:</label><input type="text" value="" name="birthday" size="10" /></li>
            ...
            <li><button type="button" class="btn-green" data-toggle="tableditadd" data-target="#tabledit1" data-num="1" data-icon="plus">添加编辑行</button></li>
            <li><button type="button" class="btn-green" onclick="$(this).tabledit('add', $('#tabledit1'), 2)">添加编辑行2</button></li>
        </ul>
    </form>
</div>
<div class="bjui-pageContent">
    <form action="ajaxDone2.html" id="j_custom_form" class="pageForm" data-toggle="validate" method="post">
        <table id="tabledit1" class="table table-bordered table-hover table-striped table-top" data-toggle="tabledit" data-initnum="0" data-layout-h="0">
            <thead>
                <tr>
                    <th title="No."><input type="text" name="customList[#index#].id" class="no" data-rule="required" value="1" size="2"></th>
                    ...
                    <th title="手机"><input type="text" name="customList[#index#].mobile" data-rule="required" value="1111111" size="5"></th>
