...
+function ($) {
    ...
    $(document).on(BJUI.eventType.initUI, function(e) {
        var $box    = $(e.target)
        var pElem =  $box.find('[data-toggle="popover"]');
        $box.find('[data-toggle="popover"]').popover({html: true,content:getPopoverContent(pElem.attr("conid")),container: 'body',animation: false});
                ...
                $.ajax({
                    ...
                    success  : function(json) {
                        ...
                        if (!html) {
                            ...
                            html = '<option value='+$nextselect.data('emptyvalue')+'>'+ html +'</option>'
                        }
        ...
        $box.find('[data-toggle="ztree"]').each(function() {
            ...
            var setting = {
                ...
                check: {
                    ...
                    chkboxType: op.chkboxType&&eval(op.chkboxType)()|| { "Y": "p", "N": "s" }
                },
                callback: {
