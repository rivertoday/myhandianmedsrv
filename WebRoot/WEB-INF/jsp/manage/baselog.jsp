...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="/baselog/gs.im" method="post">
            ...
            <li class="pull-right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu right" role="menu">
                        <li><a href="/baselog/ep.im" data-toggle="doexport" data-confirm-msg="确定要导出信息吗？">导出<span style="color: green;">全部</span></a></li>
                        <li><a href="/baselog/ep.im" data-toggle="doexportchecked" data-confirm-msg="确定要导出选中项吗？" data-idname="expids" data-group="ids">导出<span style="color: red;">选中</span></a></li>
                    </ul>
                </div>
            </li>
        </ul>
        <div class="bjui-moreSearch">
        	<label>操作员编号：</label><input type="text" value="${page.params.operator }" name="operator" class="form-control" size="10" />
