						...
						$.ajax({
	        				...
	        				success:function(msg) {
	        					if (msg == "fail") {
	        	        			...
	        	        			$.ajax({
	        	        				type:"post",
	        	        				url:"/phoneweb/password_check.html",
	        	        				...
	        	        				success:function(msg) {
	        	        					if (msg == "fail") {
	        	        	        			...
	        	        	        			confirmS("确认修改吗？", function() {
	        	        	        				$("#myform").attr("action", "/phoneweb/user/setting.html").submit();
	        	        	        			});
	        	        	        		}
	        	        				}
	        	        			});
...
<div class="f_denglu">
    ...
    <div class="f_user">
        <p class="f_user1"><img src="/phoneweb/images/f_ren02.png" /><input type="text" name="phone" id="phone" value="${userLogin.phone }" readonly="readonly" placeholder="请输入您的手机号码" /></p>
        ...
        <p class="f_user2"><img src="/phoneweb/images/f_ren03.png" /><input type="password" id="oldpwd" name="oldpwd" placeholder="请输入旧密码" /></p>
