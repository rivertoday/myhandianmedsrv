    ...
    <form action="ajaxDone1.html" id="j_form_form" class="pageForm" data-toggle="validate">
        <div class="pageFormContent" data-layout-h="0">
            <div style="margin:15px auto 0; width:600px;">
                <fieldset>
                    <legend>按钮</legend>
                    <table class="table table-condensed table-hover" width="500px">
                        <thead>
                            <tr>
                                <th>样例</th>
                                <th>Class</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><button type="button" class="btn-default" data-large="true">大尺寸按钮</button></td>
                                <td>btn-default</td>
                                <td>data-large="true"</td>
                            </tr>
                            <tr>
                                <td><button type="button" class="btn-default btn-lg" data-large="true">超大尺寸按钮</button></td>
