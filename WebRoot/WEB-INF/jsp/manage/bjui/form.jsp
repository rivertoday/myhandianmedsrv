...
function pic_upload_success(file, data) {
    ...
    if (json[BJUI.keys.statusCode] == BJUI.statusCode.ok) {
        $('#j_custom_pic').val(json.navTabId).trigger('validate')
...
//护照有效日期  = 签发日期 + 10年
$('#j_custom_issuedate').on('afterchange.bjui.datepicker', function(e) {
...
<div class="bjui-pageContent">
    <form action="ajaxDone1.html" id="j_custom_form" class="pageForm" data-toggle="validate">
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <div style="display: inline-block; vertical-align: middle;">
                                <div id="j_custom_pic_up" data-toggle="upload" data-uploader="/upload/file.im?sessionid=?" 
                                    data-file-size-limit="1024000000"
                                    data-file-type-exts="*.jpg;*.png;*.gif;*.mpg"
                                    data-multi="true"
                                    data-on-upload-success="pic_upload_success"
                                    data-icon="cloud-upload"></div>
                                <input type="hidden" name="custom.pic" value="" id="j_custom_pic" data-rule="required" data-target="#j_custom_pic_up .bjui-upload-select-file">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="checkbox" name="custom.room" id="j_custom_room" data-toggle="icheck" value="true" data-label="是否占床" checked>
                        </td>
                        <td>
