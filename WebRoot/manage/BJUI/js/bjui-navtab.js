...
+function ($) {
    ...
    Navtab.prototype.TOOLS = function() {
        ...
        var tools = {
            ...
            reloadTab: function($panel, op) {
                var $tools = this;
                $panel.trigger(BJUI.eventType.beforeLoadNavtab).data('bjui.layoutBox', $panel.closest('div.layoutBox')).ajaxUrl({
    ...
    function Plugin(option) {
        ...
        return this.each(function () {
            ...
            else if(data.options.id && data.options.id != options.id) {
            	$this.data('bjui.navtab', (data = new Navtab(this, options)));
            }else if(data.options.url && data.options.url != options.url){
            	$this.data('bjui.navtab', (data = new Navtab(this, options)));
            }
