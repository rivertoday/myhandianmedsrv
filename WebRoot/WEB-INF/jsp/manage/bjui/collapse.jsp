    ...
    <div class="pageFormContent" layouth="29">
        <div style="margin: 0 auto; width: 550px;">
            <fieldset>
                ...
                <p><span class="red">*</span> 其他参数参见<a href="http://v3.bootcss.com/javascript/#collapse" target="_blank">http://v3.bootcss.com/javascript/#collapse</a></p>
                <div class="btn-group">
                    <button type="button" class="btn-default" onclick="toCollapse(1);">紧凑型</button>
                    <button type="button" class="btn-default" onclick="toCollapse(2);">正常型</button>
                    <button type="button" class="btn-default" onclick="toCollapse(3);">自动高度</button>
                    <button type="button" class="btn-default" onclick="toCollapse(4);">固定高度：200</button>
                    <button type="button" class="btn-default" onclick="toCollapse(5);">固定高度：300</button>
                </div>
            </fieldset>
        </div>
        <br>
