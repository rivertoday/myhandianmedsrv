    ...
    <form action="ajaxDone1.html" id="j_form_form" class="pageForm form-validate" method="post" callback="navTabAjaxDone" noEnter>
        <div class="pageFormContent" layouth="29">
            <div style="margin: 0 auto; width: 700px;">
                <textarea name="content" id="j_form_content" class="j-content" style="width: 700px;" uploadJson="/kindeditor/file_upload.im" fileManagerJson="/kindeditor/file_manager.im" afterUpload="E_afterUpload" afterSelectFile="E_afterSelectFile" X_afterSelect="E_afterSelect" minheight="200">
