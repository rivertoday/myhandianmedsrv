        ...
        <div class="pageFormContent" data-layout-h="0">
            <table class="table table-condensed table-hover">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <label for="j_dialog_profession" class="control-label x90">客户职业：</label>
                            <input type="text" name="dialog.profession" id="j_dialog_profession" value="" data-rule="required" data-toggle="lookup" data-url="table-edit-lookup.html" data-group="dialog" data-width="580" data-height="300" size="20">
                        </td>
                        <td>
                            <label for="j_dialog_visa" class="control-label x85">签证：</label>
                            <input type="checkbox" name="dialog.visa" id="j_dialog_visa" value="" data-toggle="icheck" data-label="需要办理签证">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="text-center">
                            <br>
                            <label>其他业务：</label><a href="dialog-modal2.html" class="btn btn-default" data-toggle="dialog" data-width="500" data-height="280" data-id="dialog-mask2" data-mask="true">继续打开模态弹出窗口</a>
                        </td>
                    </tr>
                </tbody>
            </table>
